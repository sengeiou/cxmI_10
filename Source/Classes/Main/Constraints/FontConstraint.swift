...
let Font25 = UIFont.systemFont(ofSize: 25)
let Font26 = UIFont.systemFont(ofSize: 26)
let Font27 = UIFont.systemFont(ofSize: 27)
let Font28 = UIFont.systemFont(ofSize: 28)
let Font29 = UIFont.systemFont(ofSize: 29)
let Font30 = UIFont.systemFont(ofSize: 30)
let Font36 = UIFont.systemFont(ofSize: 36)
let Font40 = UIFont.systemFont(ofSize: 40)
