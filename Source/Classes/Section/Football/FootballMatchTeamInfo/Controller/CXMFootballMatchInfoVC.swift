...
class CXMFootballMatchInfoVC: BaseViewController, UITableViewDelegate, LotteryProtocol {
...
extension CXMFootballMatchInfoVC : FootballMatchPagerViewDelegate {
...
extension CXMFootballMatchInfoVC : FootballOddsPagerViewDelegate {
...
extension CXMFootballMatchInfoVC : UITableViewDataSource {
