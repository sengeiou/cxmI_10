...
//  彩小蜜
//
//  Created by Kairui Wang on 2019/5/21.
...
protocol CouponPopVCDelegate {
    func didTipCouponPop() -> Void
}

class CouponPopVC: UIViewController {
    
    public var delegate : CouponPopVCDelegate!
...
// MARK: - 点击事件
extension CouponPopVC {
    @objc private func didTipImageView() {
        delegate.didTipCouponPop()
