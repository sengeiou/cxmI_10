...
protocol FootballScoreCellDelegate {
    ...
    func didTipStopSelling(cell: FootballScoreCell, teamInfo : FootballPlayListModel) -> Void
}

class FootballScoreCell: UITableViewCell, DateProtocol, FootballStopSellingViewDelegate {
