...
protocol LotteryDateFilterVCDelegate {
    func didSelectDateItem(filter : CXMLotteryDateFilterVC, dateModel : LotteryDateModel ) -> Void
    
}

class CXMLotteryDateFilterVC: BasePopViewController, UITableViewDelegate, UITableViewDataSource {
