...
class AccountDetailsFilter: BasePopViewController {
...
extension AccountDetailsFilter : UITableViewDelegate {
...
extension AccountDetailsFilter : UITableViewDataSource {
