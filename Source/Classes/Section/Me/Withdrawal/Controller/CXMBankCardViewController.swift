...
class CXMBankCardViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource, BankCardFooterViewDelegate, BankCardCellDelegate {
    
    
    //MARK: - 点击事件
    func addNewBankCard() {
        let add = CXMAddNewBankCardVC()
