...
open class HHTextView: UITextView {
    ...
    private func commonInitializer() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(HHTextView.handleTextViewTextDidChangeNotification(_:)), name: NSNotification.Name.UITextViewTextDidChange, object: self)
